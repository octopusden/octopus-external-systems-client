...
class BitbucketClassicClient(
    ...
    override fun getRepository(
        projectKey: String,
        repository: String,
    ) = client.getRepository(projectKey, repository)
    ...
    override fun getPullRequests(requestParams: Map<String, Any>) = client.getPullRequests(requestParams)

    override fun deletePullRequest(
        projectKey: String,
        repository: String,
    ...
    override fun addCommitBasedBuildStatus(
        commitId: String,
    ...
    override fun getRepositoryRawFileContent(
        projectKey: String,
        repository: String,
        filePath: String,
