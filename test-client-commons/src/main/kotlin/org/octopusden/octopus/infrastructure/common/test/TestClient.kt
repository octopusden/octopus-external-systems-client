...
interface TestClient {
    fun commit(newChangeSet: NewChangeSet, parent: String? = null, commitExceptionMessage: String? = null): ChangeSet
    fun tag(vcsUrl: String, commitId: String, tag: String)
    fun exportRepository(vcsUrl: String, zip: File)
    fun importRepository(vcsUrl: String, zip: File, commitExceptionMessage: String? = null)
