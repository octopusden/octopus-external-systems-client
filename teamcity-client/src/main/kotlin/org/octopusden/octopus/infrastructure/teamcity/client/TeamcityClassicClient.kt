...
class TeamcityClassicClient(
    ...
    override fun deleteAgentRequirement(
        buildType: BuildTypeLocator,
        agentRequirementLocator: AgentRequirementLocator,
    ...
    override fun getAgentRequirements(buildType: BuildTypeLocator) =
        client.getAgentRequirements(
            buildType,
        )

    override fun addBuildTypeFeature(
        buildType: BuildTypeLocator,
    ...
    override fun getBuildTypeFeature(
        buildType: BuildTypeLocator,
        feature: String,
    ...
    override fun disableBuildStep(
        buildType: BuildTypeLocator,
        step: String,
        newValue: Boolean,
    ) = client.disableBuildStep(buildType, step, newValue)

    override fun createBuildStep(
        buildType: BuildTypeLocator,
        step: TeamcityStep,
    ...
    override fun getBuildTypeVcsRootEntry(
        buildType: BuildTypeLocator,
        vcsRootEntryId: String,
    ...
    override fun updateVcsRootProperty(
        vcsRootId: String,
        propertyName: String,
        newValue: String,
    ) = client.updateVcsRootProperty(vcsRootId, propertyName, newValue)

    override fun getVcsRootProperty(
        vcsRootId: String,
        propertyName: String,
    ...
    override fun attachTemplateToBuildType(
        buildType: BuildTypeLocator,
        template: String,
    ) = client.attachTemplateToBuildType(buildType, template)

    override fun detachTemplatesFromBuildType(buildType: BuildTypeLocator) = client.detachTemplatesFromBuildType(buildType)
    ...
    override fun getProjectsWithLocatorAndFields(
        locator: ProjectLocator,
        fields: String,
    ): TeamcityProjects = client.getProjectsWithLocatorAndFields(locator, fields)

    override fun getBuildsWithLocatorAndFields(
        locator: BuildLocator,
        fields: String,
    ) = client.getBuildsWithLocatorAndFields(locator, fields)

    override fun getBuildsByHref(href: String) = client.getBuildsByHref(href)
    ...
    override fun getBuildTypesWithVcsRootInstanceLocatorAndFields(
        ...
        fields: String,
    ): TeamcityBuildTypes = client.getBuildTypesWithVcsRootInstanceLocatorAndFields(locator, fields)
    ...
    override fun assignProjectRoleToUser(
        username: String,
        roleId: TeamcityRole,
        projectId: String,
    ) = client.assignProjectRoleToUser(username, roleId, projectId)

    override fun assignGlobalRoleToUser(
        username: String,
        roleId: TeamcityRole,
