...
interface TeamcityClient {
    ...
    @Headers("Accept: application/json")
    fun getVcsRoot(
        @Param("locator", expander = Locator::class) vcsRoot: VcsRootLocator,
    ): TeamcityVcsRoot
...
fun TeamcityClient.createBuildType(
    projectId: String,
    name: String,
...
fun TeamcityClient.addAgentRequirementToBuildType(
    buildTypeId: String,
    requirement: TeamcityAgentRequirement,
) = addAgentRequirementToBuildType(BuildTypeLocator(id = buildTypeId), requirement)

fun TeamcityClient.deleteAgentRequirement(
    buildTypeId: String,
...
fun TeamcityClient.getAgentRequirements(buildTypeId: String) = getAgentRequirements(BuildTypeLocator(id = buildTypeId))

fun TeamcityClient.addBuildTypeFeature(
    buildTypeId: String,
    feature: TeamcityLinkFeature,
...
fun TeamcityClient.getBuildTypeFeature(
    buildTypeId: String,
    feature: String,
...
fun TeamcityClient.getBuildTypeFeatureParameter(
    buildTypeId: String,
    feature: String,
    parameter: String,
) = getBuildTypeFeatureParameter(BuildTypeLocator(id = buildTypeId), feature, parameter)

fun TeamcityClient.setBuildCounter(
    buildTypeId: String,
    newValue: String,
) = setBuildCounter(BuildTypeLocator(id = buildTypeId), newValue)

fun TeamcityClient.createSnapshotDependency(
    buildTypeId: String,
    dependency: TeamcitySnapshotDependency,
) = createSnapshotDependency(BuildTypeLocator(id = buildTypeId), dependency)

fun TeamcityClient.deleteSnapshotDependency(
    buildTypeId: String,
    dependency: String,
) = deleteSnapshotDependency(BuildTypeLocator(id = buildTypeId), dependency)

fun TeamcityClient.getSnapshotDependencies(buildTypeId: String) = getSnapshotDependencies(BuildTypeLocator(id = buildTypeId))

fun TeamcityClient.disableBuildStep(
    buildTypeId: String,
    step: String,
    newValue: Boolean,
) = disableBuildStep(BuildTypeLocator(id = buildTypeId), step, newValue)

fun TeamcityClient.createBuildStep(
    buildTypeId: String,
    step: TeamcityStep,
...
fun TeamcityClient.createBuildTypeVcsRootEntry(
    buildTypeId: String,
    vcsRootEntry: TeamcityCreateVcsRootEntry,
) = createBuildTypeVcsRootEntry(BuildTypeLocator(id = buildTypeId), vcsRootEntry)

fun TeamcityClient.deleteBuildTypeVcsRootEntry(
    buildTypeId: String,
    vcsRootEntryId: String,
) = deleteBuildTypeVcsRootEntry(BuildTypeLocator(id = buildTypeId), vcsRootEntryId)

fun TeamcityClient.getBuildTypeVcsRootEntries(buildTypeId: String) = getBuildTypeVcsRootEntries(BuildTypeLocator(id = buildTypeId))

fun TeamcityClient.getBuildTypeVcsRootEntry(
    buildTypeId: String,
    vcsRootEntryId: String,
...
fun TeamcityClient.getBuildWithFields(
    buildId: String,
    fields: String,
...
fun TeamcityClient.attachTemplateToBuildType(
    buildTypeId: String,
    template: String,
) = attachTemplateToBuildType(BuildTypeLocator(id = buildTypeId), template)

fun TeamcityClient.detachTemplatesFromBuildType(buildTypeId: String) = detachTemplatesFromBuildType(BuildTypeLocator(id = buildTypeId))
...
fun TeamcityClient.uploadMetarunner(
    projectId: String,
    fileName: String,
