...
private const val TOKEN = "eyJ0eXAiOiAiVENWMiJ9.cm5PdEMyNlZ0Zy1xZnR1cVpEN1RfN3E2ODlJ.OGExZWY2YzYtNmMwNC00N2Q2LTgyOTQtOTNkOTlhMmM2YTc2"

class TeamcityClassicClientV25Test {

    private val client by lazy {
        TeamcityClassicClient(
            object : ClientParametersProvider {
                override fun getApiUrl() = "http://$HOST"
                override fun getAuth() = StandardBearerTokenCredentialProvider(TOKEN)
            }
        )
    }
    ...
    fun testUploadRecipe() {
        ...
        checkHtmlContent("http://$HOST/admin/editProject.html?projectId=$projectId&tab=recipe&editRecipeId=$recipeId", "recipeContent", String(testRecipeCreateContent))
        ...
        checkHtmlContent("http://$HOST/admin/editProject.html?projectId=$projectId&tab=recipe&editRecipeId=$recipeId", "recipeContent", String(testRecipeEditContent))
    }
